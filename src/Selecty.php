...
class Selecty extends Field
{
    /**
     * @var string
     */
    protected $view = 'laravel-admin-selecty::selecty';
	 ...
	 * Set target.
	 *
	 * @param array|callable|string $target
	 *
	 * @return $this|mixed
	 */
...
EOT;
	...
	public function render()
	{
		...
		if ($this->target instanceof \Closure) {
			if ($this->form) {
				$this->target = $this->target->bindTo($this->form->model());
			}
			$this->target(call_user_func($this->target, $this->value, $this));
		}
